    ...
    return  <div className="container">
              <div className="row">
                <div className="col-sm-12">
                  ...
                  <h2>Saved Cards<span className="show-hide-advanced-filter"><ShowHideButton target={".advanced-filters"} showText="+" hideText="-" startClosed="false"/></span></h2>
                  {this.props.renderCards(this.state.savedCards)}
